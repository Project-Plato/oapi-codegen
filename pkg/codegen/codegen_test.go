...
import (
	...
	examplePetstoreClient "github.com/truvity/oapi-codegen/examples/petstore-expanded"
	examplePetstore "github.com/truvity/oapi-codegen/examples/petstore-expanded/echo/api"
)
